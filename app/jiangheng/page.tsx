...
export default async function JiangHengPage() {
  ...
  return (
    <main className="min-h-screen bg-brand-bg pt-24 pb-20 px-5 font-sans">
      <div className="max-w-4xl mx-auto">
        <Link href="/" className="inline-flex items-center text-[#B1B3B3] hover:underline mb-10 text-sm">
          &larr; Back to Home
        </Link>

        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-5xl font-semibold mb-4 tracking-wide drop-shadow-sm text-[#B1B3B3] font-serif">
            Jiangheng <br />
            Project 
          </h1>
          <p className="text-[#a0a0a0] text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            จากความรักและการสนับสนุนของแฟนๆ <br />
            สู่โปรเจกต์พิเศษเพื่อเจียงเหิงใน DESIRE4 1st Concert in Bangkok
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-14">
          ...
          <div className="lg:col-span-3 bg-brand-card border border-brand-border rounded-3xl p-7 md:p-9 shadow-[0_10px_40px_rgba(0,0,0,0.35)] relative overflow-hidden">
            ...
            {/* Glow */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(177,179,179,0.15),transparent_40%)] pointer-events-none" />
            ...
            <div className="relative z-10 mb-10">
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
                ...
                <div>
                  <h2 className="text-5xl md:text-7xl font-bold text-[#B1B3B3] leading-none drop-shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex flex-col justify-center space-y-6">
                <div className="bg-accent/5 border border-accent/20 rounded-2xl p-6">
                  ...
                  <Link 
                    href="https://x.com/OceanJiangTH/status/2055975077082976749?s=20" 
                    target="_blank"
