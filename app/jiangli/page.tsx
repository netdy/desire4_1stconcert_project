...
export default async function JiangLiPage() {
    ...
    <main className="min-h-screen bg-brand-bg pt-24 pb-20 px-5 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-5xl font-semibold mb-4 tracking-wide drop-shadow-sm text-[#10b981] font-serif">
            JiangLi <br />
            Project 
          </h1>
          <p className="text-[#a0a0a0] text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            จากความรักและการสนับสนุนของแฟนๆ <br />
            สู่โปรเจกต์พิเศษเพื่อเจียงเหิงและหลี่เพ่ยเอินใน DESIRE4 1st Concert in Bangkok
          </p>
        </div>
          ...
          <div className="lg:col-span-3 bg-brand-card border border-brand-border rounded-3xl p-7 md:p-9 shadow-[0_10px_40px_rgba(0,0,0,0.35)] relative overflow-hidden">
            ...
            <div className="relative z-10 mb-10">
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
                ...
                <div>
                  <h2 className="text-5xl md:text-7xl font-bold text-[#10b981] leading-none drop-shadow-md">
                  ...
                  <div key={goal.id} className={`p-5 rounded-2xl transition-all duration-500 border ${isCompleted ? 'bg-accent/[0.03] border-accent/20 shadow-[inset_0_0_20px_rgba(212,175,55,0.03)]' : 'bg-transparent border-transparent p-0'}`}>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="text-right">
                        <p className={`font-semibold text-sm ${isCompleted ? 'text-accent drop-shadow-md' : 'text-[#10b981]'}`}>
                          {goal.progress}%
                        </p>
                      </div>
                    </div>
                      ...
                      <div
                        className={`h-full rounded-full transition-all duration-1000 relative overflow-hidden ${
                          isCompleted 
                            ...
                            : 'bg-gradient-to-r from-[#065f46] via-[#10b981] to-[#d4af37] shadow-[0_0_8px_rgba(16,185,129,0.3)]'
                        }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#111] border border-[#2a2a2a] rounded-2xl p-6 space-y-4 shadow-inner">
                  <div>
                    ...
                    <p className="text-white font-medium">ไทยพาณิชย์ (SCB)</p>
                  </div>
                  <div>
                    <p className="text-[#666] text-[10px] uppercase tracking-widest mb-1 font-bold">เลขบัญชี / Account Number</p>
                    <p className="text-[#10b981] text-2xl md:text-3xl font-bold tracking-wider">315-279388-2</p>
                  </div>
                  <div>
              ...
              <div className="flex flex-col justify-center space-y-6">
                <div className="bg-accent/5 border border-accent/20 rounded-2xl p-6">
                  ...
                  <Link 
                    href="https://x.com/Jiangli_lele_TH/status/2054915828232163628?s=20" 
                    target="_blank"
